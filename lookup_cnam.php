...
while (1) {
    $result = mysql_query("select distinct survey_results.phonenumber from survey_results where survey_results.campaign_id = $campaign and phonenumber not in (select phonenumber from names) limit 100");
