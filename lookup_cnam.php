...
while (1) {
    $result = mysql_query("select distinct survey_results.phonenumber from survey_results where survey_results.campaign_id = $campaign and phonenumber in (select phonenumber from names) ORDER BY RAND() limit 100");
