...
if (isset($_GET[type])){
    ...
    if ($_GET[type] == "unknown") {
        ...
        if (isset($_GET['sure'])) {
            ...
            <br/>
            <a href="recycle_new.php?type=deleteall&id=<?= $_GET['id'] ?>&sure=yes">Yes, Delete all numbers</a><br/>
            <a href="new_campaign.php?view=1">No, don't delete all numbers</a>
            <?
            require "footer.php";
            exit(0);
        }
    ...
    header("Location: new_campaign.php?view=1");
    exit(0);
} else {
...
?><a href="recycle_new.php?id=<?= $id; ?>&type=<?= $status ?>&type_input=<? echo $_GET[type_input]; ?>"><?
    ...
    <center>
        ...
        <center><h2>Recycle Numbers:</h2>
            ...
            <a href="recycle_new.php?id=<? echo $_GET[id]; ?>&type=unknown&type_input=<? echo $_GET[type_input]; ?>">
                Reset <?
            ...
            if ($config_values['DISABLE_RECYCLE_ALL'] == "NO") {
                ...
                <a href="recycle_new.php?id=<? echo $_GET[id]; ?>&type=all&type_input=<? echo $_GET[type_input]; ?>">
                    <b>Reset all <?
