...
for($i = 0;$i<$x;$i++) {
    ...
    echo '<a href="system_bill_graph.php?size=300&max='.$highest.'&groupid='.$groupid[$i].'"><img src="system_bill_graph.php?size=300&max='.$highest.'&groupid='.$groupid[$i].'" width="100" border="0"></a>';
    echo "<br>";
