<h3>Introduction</h3>
<p align="left">The aim of this part is to provide a quick introduction for <?echo stripslashes($config_values['TITLE']);?>. This quick start will show you how to create campaigns. For this we're going to create a simple Load Simulation campaign.</p>
...
<p align="left">In <?echo stripslashes($config_values['TITLE']);?> there are seven types of campaign (with
