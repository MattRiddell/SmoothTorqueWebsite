...
<p align="left">What each of the different icons do will be explained later on.</p>
...
<p align="left">This is a list of numbers that will <em>never</em> be called. This list is global for all campaigns on the system, unlike the numbers for a particular campaign. For now, we are only going to add three numbers to this list. So, click on the Add DNC Numbers Manually button. You will then be presented with a dialog like the one below.
