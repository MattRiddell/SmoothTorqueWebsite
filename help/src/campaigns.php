...
<p align="left">In <?echo stripslashes($config_values['TITLE']);?> there are seven types of campaign (with more planned). Their properties are outlined in the table below.</p>
...
<p align="left">The Queue Mode specific option is to specify the name of the queue. Note: The queue must exist in Asterisk (as either a RealTime Queue --- as set up by <?echo stripslashes($config_values['TITLE']);?>, or as a static queue in queue.conf) before you can use this feature.</p>
