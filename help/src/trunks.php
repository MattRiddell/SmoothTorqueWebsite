...
<p align="left">To add a trunk, click on the Add Trunk item. You will then have 4 fields to fill out. The first is a trunk name (this is a name that <?echo stripslashes($config_values['TITLE']);?> can use), the next is the Dial String (examples of which are given below), the next options specify the maximum number of calls per second and the maximum number of channels this trunk can support.</p>
