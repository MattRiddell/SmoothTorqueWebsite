...
$chart[ 'axis_value' ] = array ( 'size'=>9, 'color'=>"000000", 'alpha'=>65, 'steps'=>10, 'suffix'=>"", 'max'=>240 );
...
$chart[ 'chart_rect' ] = array ( 'x'=>40, 'y'=>25, 'width'=>950, 'height'=>240, 'positive_color'=>"ffffff",
...
'h_align'=>"left", 'v_align'=>"bottom" ),
array ( 'type'=>"text", 'color'=>"444444", 'alpha'=>100, 'font'=>"arial", 'rotation'=>0,
'bold'=>true, 'size'=>15, 'x'=>505, 'y'=>180, 'width'=>300, 'height'=>300, 'text'=>"Max Running Speed: ".round($mrs,2)." 
(".round($mrs/2000*100)."%)",
'h_align'=>"left", 'v_align'=>"bottom" ),
array ( 'type'=>"text", 'color'=>"444444", 'alpha'=>100, 'font'=>"arial", 'rotation'=>0,
...
echo '<img src="graph.php?id='.$id.'&x='.microtime().'">';
?>
