...
<div onClick="hideshow('misc'); return false;"><p>Miscellaneous Configuration Options <img src="images/closed.png" name="img_misc"></p></div>
<table class="" align="center" border="0" cellpadding="2" cellspacing="0" id="misc" style="display:none">
<tr class="tborder2" title="The music played to the people in the queue"><td class="thead">Music on Hold<a href="#" onClick="displaySmallMessage('/includes/help.php?section=The music played while someone is waiting in the queue');return false;"><img src="images/help.png" border="0"></a></td><td><input type="text" value="<?echo $row[musiconhold];?>" name="musiconhold" maxlength="<?echo $is_int[musiconhold][1]?>"></td><td><p onClick="resetToDefault('musiconhold','default');">default</p></td></tr>
<tr class="tborderx" title="The message to play to an agent who picks up the phone"><td class="thead">Announce<a href="#" onClick="displaySmallMessage('/includes/help.php?section=Play this message when an agent picks up the phone to service someone in the queue');return false;"><img src="images/help.png" border="0"></a></td><td><input type="text" value="<?echo $row[announce];?>" name="announce" maxlength="<?echo $is_int[announce][1]?>"></td><td><p onClick="resetToDefault('announce','');">default</p></td></tr>
<tr class="tborder2" title="Where the call goes if the person in the queue dials a digit"><td class="thead">Context<a href="#" onClick="displaySmallMessage('/includes/help.php?section=What happens to the call if the person presses a key, for example if they press 1');return false;"><img src="images/help.png" border="0"></a></td><td><input type="text" value="<?echo $row[context];?>" name="context"  maxlength="<?echo $is_int[context][1]?>"></td><td><p onClick="resetToDefault('context','');">default</p></td></tr>
<tr class="tborder2" title="How long to wait before presenting a call to another free agent"><td class="thead">Retry<a href="#" onClick="displaySmallMessage('/includes/help.php?section=If a timeout occourse this value determines how long to wait before presenting the call to another free agent');return false;"><img src="images/help.png" border="0"></a></td><td><input type="text" value="<?echo $row[retry];?>" name="retry"  maxlength="<?echo $is_int[retry][1]?>"></td><td><p onClick="resetToDefault('retry','');">default</p></td></tr>
<tr class="tborderx" title="Ideally how long a call has to wait before being presented to an agent"><td class="thead">Service Level<a href="#" onClick="displaySmallMessage('/includes/help.php?section=This value represents, ideally how long a call has to wait before being presented to an agent');return false;"><img src="images/help.png" border="0"></a></td><td><input type="text" value="<?echo $row[servicelevel];?>" name="servicelevel"  maxlength="<?echo $is_int[servicelevel][1]?>"></td><td><p onClick="resetToDefault('servicelevel','0');">default</p></td></tr>
<tr class="tborder2" title="How often to announce to a person their position in the queue and the estimated wait time"><td class="thead">Announce Frequency<a href="#" onClick="displaySmallMessage('/includes/help.php?section=How often (in seconds) to announce to a person in the queue their position and estimated wait time. 0 is off');return false;"><img src="images/help.png" border="0"></a></td><td><input type="text" value="<?echo $row[announce_frequency];?>" name="announce_frequency"  maxlength="<?echo $is_int[accounce_frequency][1]?>"></td><td><p onClick="resetToDefault('announce_frequency','0');">default</p></tr>
<tr class="tborderx" title="If the hold time should be played to the person in the queue, how often should it be played?"><td class="thead">Announce Holdtime<a href="#" onClick="displaySmallMessage('/includes/help.php?section=Determines if the announcement should include the estimated hold time. Possible values:<br>Once --- only play the message once<br>Yes --- play the message as often as specified<br>No --- don&#96;t play the message at all');return false;"><img src="images/help.png" border="0"></a></td><td><input type="text" value="<?echo $row[announce_holdtime];?>" name="announce_holdtime"  maxlength="<?echo $is_int[announce_holdtime][1]?>"></td><td><p onClick="resetToDefault('announce_holdtime','');">default</p></tr>
<tr class="tborder2" title="The max number of calls in the queue before continuing on with the dialplan"><td class="thead">Max Queue Length<a href="#" onClick="displaySmallMessage('/includes/help.php?section=The maximum number of calls in the queue before going on to the next priority of the current extension. Essentially, if there are too many people in the queue, then the next step of the dial plan will be executed.');return false;"><img src="images/help.png" border="0"></a></td><td><input type="text" value="<?echo $row[maxlen];?>" name="maxlen"  maxlength="<?echo $is_int[maxlen][1]?>"></td><td><p onClick="resetToDefault('maxlen','');">default</p></tr>
<tr class="tborder2" title="The time after the call has finished for the agent to finish their work."><td class="thead">Wrapup time<a href="#" onClick="displaySmallMessage('/includes/help.php?section=The time after the call has finished for the agent to finish their work');return false;"><img src="images/help.png" border="0"></a></td><td><input type="text" value="<?echo $row[wrapuptime];?>" name="wrapuptime"  wrapuptime="<?echo $is_int[wrapuptime][1]?>"></td><td><p onClick="resetToDefault('wrapuptime','');">default</p></tr>
</table>

<p onClick="hideshow('sound');">Sound Files <img src="images/closed.png" name="img_sound"></p>
<table class="" align="center" border="0" cellpadding="2" cellspacing"0" id="sound" style="display:none">
<tr class="tborderx" title="The message 'you are next'"><td class="thead">You are next<a href="#" onClick="displaySmallMessage('/includes/help.php?section=The file that is used for the message: You are next');return false;"><img src="images/help.png" border="0"></a></td><td><input type="text" value="<?echo $row[queue_youarenext];?>" name="queue_youarenext"  maxlength="<?echo $is_int[queue_youarenext][1]?>"></td><td><p onClick="resetToDefault('queue_youarenext','queue-youarenext');">default</p></td></tr>
<tr class="tborder2" title="The message 'there are...'"><td class="thead">There are...<a href="#" onClick="displaySmallMessage('/includes/help.php?section=The path to the file that is used for the message: There are');return false;"><img src="images/help.png" border="0"></a></td><td><input type="text" value="<?echo $row[queue_thereare];?>" name="queue_thereare" maxlength="<?echo $is_int[queue_thereare][1]?>"></td><td><p onClick="resetToDefault('queue_thereare','queue-thereare');">default</p></td></tr>
<tr class="tborderx" title="The message 'calls waiting'"><td class="thead">Calls waiting<a href="#" onClick="displaySmallMessage('/includes/help.php?section=File for the message: calls waiting.');return false;"><img src="images/help.png" border="0"></a></td><td><input type="text" value="<?echo $row[queue_callswaiting];?>" name="queue_callswaiting" maxlength="<?echo $is_int[queue_callswaiting][1]?>"></td><td><p onClick="resetToDefault('queue_callswaiting','queue-callswaiting');">default</p></td></tr>
<tr class="tbordeR2" title="The message 'current estimated hold time is'"><td class="thead">Hold time<a href="#" onClick="displaySmallMessage('/includes/help.php?section=File for the message: The current estimated hold time is');return false;"><img src="images/help.png" border="0"></a></td><td><input type="text" value="<?echo $row[queue_holdtime];?>" name="queue_holdtime" maxlength="<?echo $is_int[queue_holdtime][1]?>"></td><td><p onClick="resetToDefault('queue_holdtime','queue-holdtime');">default</p></td></tr>
<tr class="tborderx" title="The message for 'minutes'"><td class="thead">Minutes<a href="#" onClick="displaySmallMessage('/includes/help.php?section=File for the message: minutes.');return false;"><img src="images/help.png" border="0"></a></td><td><input type="text" value="<?echo $row[queue_minutes];?>" name="queue_minutes" maxlength="<?echo $is_int[queue_minutes][1]?>"></td><td><p onClick="resetToDefault('queue_minutes','queue-minutes');">default</p></td></tr>
<tr class="tborder2" title="The message 'seconds'"><td class="thead">Seconds<a href="#" onClick="displaySmallMessage('/includes/help.php?section=File for the message: seconds.');return false;"><img src="images/help.png" border="0"></a></td><td><input type="text" value="<?echo $row[queue_seconds];?>" name="queue_seconds" maxlength="<?echo $is_int[queue_seconds][1]?>"></td><td><p onClick="resetToDefault('queue_seconds','queue-seconds');">default</p></td></tr>
<tr class="tborderx" title="The message 'less than...'"><td class="thead">Less than...<a href="#" onClick="displaySmallMessage('/includes/help.php?section=File for the message: less than');return false;"><img src="images/help.png" border="0"></a></td><td><input type="text" value="<?echo $row[queue_lessthan];?>" name="queue_lessthan" maxlength="<?echo $is_int[queue_lessthan][1]?>"></td><td><p onClick="resetToDefault('queue_lessthan','queue-less-than');">default</p></td></tr>
<tr class="tborder2" title="The message 'thank you for your patience'"><td class="thead">Thank you<a href="#" onClick="displaySmallMessage('/includes/help.php?section=File for the message: Thank you for your patience.');return false;"><img src="images/help.png" border="0"></a></td><td><input type="text" value="<?echo $row[queue_thankyou];?>" name="queue_thankyou" maxlength="<?echo $is_int[queue_thankyou][1]?>"></td><td><p onClick="resetToDefault('queue_thankyou','queue-thankyou');">default</p></td></tr>
</table>

<p onClick="hideshow('recording');">Recording Options <img src="images/closed.png" name="img_recording"></p>

<table class="" align="center" border="0" cellpadding="2" cellspacing"0" id="recording" style="display:none">
<tr class="tborderx" title="Asterisk records conversations in two files, join them together at the end of the call?"><td class="thead">Monitor Join<a href="#" onClick="displaySmallMessage('/includes/help.php?section=Normaly when asterisk records a conversation it will record the different sides in different files, this option tells asterisk to join the files together at the end of the call.');return false;"><img src="images/help.png" border="0"></a></td><td><input type="checkbox" <?echo ($row[monitor_join]?"checked":"");?> name="monitor_join" maxlength="<?echo $is_int[monitor_join][1]?>"></td><td><p onClick="resetToDefault('monitor_join','');">default</p></td></tr>
<tr class="tborder2" title="Format for recoding calls --- wav, gsm, or wav49"><td class="thead">Monitor Format<a href="#" onClick="displaySmallMessage('/includes/help.php?section=The format for recording the calls, possible values are wav, gsm or wav49. If this option is not specified then no calls will be recorded.');return false;"><img src="images/help.png" border="0"></a></td><td><input type="text" value="<?echo $row[monitor_format];?>" name="monitor_format" maxlength="<?echo $is_int[monitor_format][1]?>"></td><td><p onClick="resetToDefault('monitor_format','');">default</p></tr>
<tr class="tborderx" title="Generate information about members of the queue? WARNING: can be lots of information"><td class="thead">Event Member Status<a href="#" onClick="displaySmallMessage('/includes/help.php?section=If selected then the manager will generate a lot of information about the members of the queue (specifically the eveng QueueMemberStatus). WARNING This can be a lot more information.');return false;"><img src="images/help.png" border="0"></a></td><td><input type="checkbox" <?echo ($row[eventmemberstatus]?"checked":"");?> name="eventmemberstatus" maxlength="<?echo $is_int[eventmemberstatus][1]?>""></td><td><p onClick="resetToDefault('eventmemberstatus','');">default</p></td></tr>
<tr class="tborder2" title="Select manager events are generated when an agent is called"><td class="thead">Event When Called<a href="#" onClick="displaySmallMessage('/includes/help.php?section=If this option is ticked, then the following manager events will be generated: AgentCalled, AgentDump, AgentConnect and AgentComplete');return false;"><img src="images/help.png" border="0"></a></td><td><input type="checkbox" <?echo ($row[eventwhencalled]?"checked":"");?> name="eventwhencalled" maxlength="<?echo $is_int[eventwhencalled][1]?>"></td><td><p onClick="resetToDefault('eventwhencalled','');">default</p></tr>
</table>

<p onClick="hideshow('queue');">Queue Performance <img src="images/closed.png" name="img_queue"></p>
<table class="" align="center" border="0" cellpadding="2" cellspacing"0" id="queue" style="display:none">
<tr class="tborderx" title="Is a caller allowed to join a queue when there are no agents?"><td class="thead">Join when Empty<a href="#" onClick="displaySmallMessage('/includes/help.php?section=This determines if a caller is allowed to join a queue with no agents in it. Possible options: <br>Yes --- allow the callers to join queues with no members of unavailable members<br>NO --- disallow the callers to join a queue with no members<br>Strict --- the callers cannot join a queue with no members, but are allowed to join one with unavailable members');return false;"><img src="images/help.png" border="0"></a></td><td><input type="text" value="<?echo $row[joinempty];?>" name="joinempty" maxlength="<?echo $is_int[joinempty][1]?>"></td><td><p onClick="resetToDefault('joinempty','');">default</p></td></tr>
<tr class="tborder2" title="Allow the removal of callers from the queue?"><td class="thead">Leave When Empty<a href="#" onClick="displaySmallMessage('/includes/help.php?section=This options allows the removing of callers from the queue, if there are new callers which cannot join. The possibly values are the same as for joinempty.');return false;"><img src="images/help.png" border="0"></a></td><td><input type="textbox" name="leavewhenempty" maxlength="<?echo $is_int[leavewhenempty][1]?>"></td><td><p onClick="resetToDefault('leavewhenempty','');">default</p></tr>
<tr class="tborderx" title="Report the hold time to the agent before they talk to the person in the queue?"><td class="thead">Report Hold Time<a href="#" onClick="displaySmallMessage('/includes/help.php?section=Report the hold time to the agent before they talk to the person in the queue.');return false;"><img src="images/help.png" border="0"></a></td><td><input type="checkbox" <?echo ($row[reportholdtime]?"checked":"");?>" name="reportholdtime" maxlength="<?echo $is_int[reportholdtime][1]?>"></td><td><p onClick="resetToDefault('reportholdtime','');">default</p></td></tr>
<tr class="tborder2" title="The weight assigned to the queue, higher the weight, the more urgent it is"><td class="thead">Weight<a href="#" onClick="displaySmallMessage('/includes/help.php?section=When a channel is included in more than one queue, the higher weighted queue will be answered first.');return false;"><img src="images/help.png" border="0"></a></td><td><input type="text" value="<?echo $row[weight];?>" name="weight" maxlength="<?echo $is_int[weight][1]?>">
</td><td><p onClick="resetToDefault('weight','');">default</p></tr>
<tr class="tborderx" title="A number of seconds of silence is played before the call is connected to the agent"><td class="thead">Member Delay<a href="#" onClick="displaySmallMessage('/includes/help.php?section=A number of seconds of silence before the member of the queue is connected to the agent');return false;"><img src="images/help.png" border="0"></a></td><td><input type="text" value="<?echo $row[memberdelay];?>" name="memberdelay" maxlength="<?echo $is_int[memberdelay][1]?>"></td><td><p onClick="resetToDefault('memberdelay','');">default</p></tr>
</table>
<input class="btn btn-primary" type="submit" value="Save Queue">
</form>
<?php
require "footer.php";
?>
