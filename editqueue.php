...
<tr class="tborder2"><td class="thead">Announce Frequency<a href="#" onClick="displaySmallMessage('/includes/help.php?section=How often (in seconds) to announce to a person in the queue their position and estimated wait time. 0 is off');return false;"><img src="./images/help.png" border="0"></a></td><td><input type="text" value="<?echo $row[announce_frequency];?>" name="announce_frequency"  maxlength="<?echo $is_int[accounce_frequency][1]?>"></td><td><p onClick="resetToDefault('announce_frequency','0');">default</p></tr>
