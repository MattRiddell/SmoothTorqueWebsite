...
?>
    ...
    <form action="editcampaign.php" method="POST" id="addcampaign">
        <table class="tborder" align="center" border="0" cellpadding="0" cellspacing="2">
            ...
            if ($config_values['EVERGREEN'] == "YES") {
                ...
                <TR title="Evergreen Mode">
                    <TD CLASS="thead">Allow Campaigns To Run Indefinitely
                    ...
                    <TD>
                        <INPUT TYPE="radio" NAME="evergreen" VALUE="1" <? if ($row['evergreen'] == 1) {
                            echo "checked";
                        } ?>> Yes&nbsp;
                        <INPUT TYPE="radio" NAME="evergreen" VALUE="0" <? if ($row['evergreen'] == 0) {
                            echo "checked";
                        } ?>> No<br/>
                    </TD>
                </TR>
            ...
            if ($config_values['configurable_drive'] == 1) {
                ...
                <TR title="Configurable Drive">
                    <TD CLASS="thead">Configurable Drive
                    ...
                    <TD>
                        Minimum Drive (Default 43.0)
                        <input type="text" name="drive_min" value="<?= $row['drive_min'] ?>"><br/>
                        Maximum Drive (Default 61.0)
                        <input type="text" name="drive_max" value="<?= $row['drive_max'] ?>">
            ...
            <tr id="mode">
                ...
                <td width=*>
                    <input type="radio" name="mode" <? if ($row['mode'] == "0") {
                        echo "selected";
                    } ?> value="didmode" rel="didmode" id="mode_did" checked onclick="document.getElementById('queue_field').style.display = 'none';document.all['queue_field'].style.display = 'none';"/>
                    <label for="mode_did" title="Which number to receive the calls at">DID Mode</label>
                    <input type="radio" name="mode" value="mode_queue" <? if ($row['mode'] == "1") {
                        echo "checked";
                    } ?> id="mode_queue" onclick="document.getElementById('queue_field').style.display = '';document.all['queue_field'].style.display = 'visible';"/>
   ...
   */ ?>
            ...
            <TR id="survey" style="display:none" title="The survey you would like to run">
                <TD CLASS="thead">Survey
   ...
   */ ?>
            ...
            ?>
            <TR id="sms" style="display:none" title="The SMS you would like to send">
                <TD CLASS="thead">SMS Message
