...
// echo $_POST[name];
            ...
            box_start();
            ?>
            <h3>Please type the range you would like for the phone numbers.</h3>
            <br/>
            <FORM ACTION="gennumbers.php" METHOD="POST">
                <table class="tborderxsxx" align="center" border="0" cellpadding="0" cellspacing="2">
                    <TR>
            ...
            */
            ...
            ?>
            <h3>
                Please type the range you would like for the phone numbers.</h3>
            <br/>

            <FORM ACTION="gennumbers.php" METHOD="POST" class="form-horizontal">
                <div class="form-group">
                    <label for="start">Start Number</label>
                    <INPUT TYPE="HIDDEN" NAME="campaignid" VALUE="<?echo $_POST[campaignid]; ?>">
                    <INPUT TYPE="TEXT" NAME="start" id="start" VALUE="16035550000" size="20">
                </div>
                <div class="form-group">
                    <label for="end">End Number</label>
                    <INPUT TYPE="TEXT" NAME="end" id="end" VALUE="16035559999" size="20">
                </div>
                        <INPUT class="btn btn-primary" TYPE="SUBMIT" VALUE="Generate Numbers">
