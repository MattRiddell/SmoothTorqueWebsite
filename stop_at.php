...
if ($count >= $press1s_to_stop_at) {
    ...
    $sql2="INSERT INTO queue (campaignid,queuename,status,starttime,endtime,startdate,enddate) VALUES ('$row[campaignid]','scheduled-stop-$campaignid_to_stop','2','00:00:00','23:59:59','2005-01-01','2099-01-01') ";
