...
$found = 0;
$sql = 'SELECT count(*) from number where campaignid='.$_GET[id].' and status!="no-credit" status!="new" and status!="dialing" and status!="dialed" and status!="answered" '.$timedate;
$result2=mysql_query($sql, $link) or die (mysql_error());;
